...
type ProductServiceClient interface {
	GetProduct(context.Context, *connect.Request[_go.GetProductRequest]) (*connect.Response[_go.Product], error)
}
...
func NewProductServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProductServiceClient {
	...
	productServiceMethods := _go.File_product_proto.Services().ByName("ProductService").Methods()
	return &productServiceClient{
		getProduct: connect.NewClient[_go.GetProductRequest, _go.Product](
			httpClient,
...
type productServiceClient struct {
	getProduct *connect.Client[_go.GetProductRequest, _go.Product]
}

// GetProduct calls product.ProductService.GetProduct.
func (c *productServiceClient) GetProduct(ctx context.Context, req *connect.Request[_go.GetProductRequest]) (*connect.Response[_go.Product], error) {
...
func (UnimplementedProductServiceHandler) GetProduct(context.Context, *connect.Request[_go.GetProductRequest]) (*connect.Response[_go.Product], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("product.ProductService.GetProduct is not implemented"))
}
